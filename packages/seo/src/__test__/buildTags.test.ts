...
describe("buildTags function", () => {
    ...
    it("should generate a complete set of tags for a blog post", async () => {
        ...
        expect(result).toContain(
            '<meta property="article:expiration_time" content="2022-01-03T12:00:00Z">'
        );
        expect(result).toContain(
        ...
        expect(result).toContain(
            '<meta property="article:author" content="https://www.facebook.com/john-doe">'
        );
        expect(result).toContain(
            '<meta property="article:author" content="https://www.facebook.com/jane-doe">'
        );
